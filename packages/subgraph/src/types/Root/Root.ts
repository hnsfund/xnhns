...
export class TLDRegistered extends ethereum.Event {
  get params(): TLDRegistered__Params {
    return new TLDRegistered__Params(this);
  }
}

export class TLDRegistered__Params {
  _event: TLDRegistered;

  constructor(event: TLDRegistered) {
    this._event = event;
  }
...
export class TLDUnregistered__Params {
  _event: TLDUnregistered;

  constructor(event: TLDUnregistered) {
    this._event = event;
  }
...
export class Root extends ethereum.SmartContract {
  ...
  reclaim(id: BigInt, _owner: Address): boolean {
    let result = super.call("reclaim", "reclaim(uint256,address):(bool)", [
  ...
  try_reclaim(id: BigInt, _owner: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("reclaim", "reclaim(uint256,address):(bool)", [
      ethereum.Value.fromUnsignedBigInt(id),
      ethereum.Value.fromAddress(_owner)
    ]);
    if (result.reverted) {
  ...
  tldControllers(param0: BigInt): Address {
    let result = super.call(
      "tldControllers",
      "tldControllers(uint256):(address)",
  ...
  try_tldControllers(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "tldControllers",
      "tldControllers(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
