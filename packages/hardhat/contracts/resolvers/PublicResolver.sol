...
contract PublicResolver is ABIResolver, AddrResolver, ContentHashResolver, InterfaceResolver, PubkeyResolver, TextResolver, NameResolver, DNSResolver, Ownable {
    ...
    /**
     * @dev A mapping of authorisations. An address that is authorised for a name
    ...
    function isAuthorised(bytes32 node) internal override view returns(bool) {
        ...
        return owner == msg.sender || authorisations[node][owner][msg.sender] || msg.sender == this.owner();
    }
